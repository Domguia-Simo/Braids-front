...
//Passion braids
import passionBraids1 from "../../assets/image/Passion_twist/1.jpg"
...
export default function DesignDetail2() {
                ...
                <MDBRow>
                    ...
                    <MDBCol md={5}>
                        ...
                        <MDBRow className='pb-1'>
                            <p style={{
                                width: "100%",
                                height: screenWidth < 750 ? "fit-content" : "330px",
                                overflowY: "auto"
                            }}>
                                {item[id].description}
                            </p>
                        ...
                        >
                            <div className='header'
                                ...
                                <h4 className='fa fa-money-check-dollar' style={{ color: "goldenrod" }} >&nbsp;${item[id].price}</h4>
                                &nbsp;&nbsp;&nbsp;
                                <h4 className='fa fa-clock' style={{ color: "goldenrod" }} >&nbsp;{item[id].duration} mins</h4>
                            </div>
                        </MDBFooter>
                        <MDBFooter className='d-flex justify-content-arround'>
                            <button
                            ...
                            <button
                                ...
                                Less<i className='fas fa-long-arrow-down'></i>
                            </button>
                        </MDBFooter>
                    </MDBCol>
                </MDBRow>
